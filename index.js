...
const auth = new google.auth.GoogleAuth({
  keyFile: './service-account.json', // Secret Manager経由で安全に扱う構成推奨
  scopes: ['https://www.googleapis.com/auth/calendar.readonly'],
});

// Googleカレンダーの設定
const calendar = google.calendar({ version: 'v3', auth });
const CALENDAR_ID = 'jks.watanabe.dojo@gmail.com'; // 正しいカレンダーIDに変更
...
const USER_ID = 'U5cb571e2ad5fcbcdfda8f2105edd2f0a'; // テスト対象のユーザーID

// 日付を日本時間で今日の0:00～23:59に設定
